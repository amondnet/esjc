...
public class FilteredReadAllEventsForwardOperation extends AbstractOperation<AllEventsSlice, FilteredReadAllEventsCompleted>  {
    ...
    public FilteredReadAllEventsForwardOperation(CompletableFuture<AllEventsSlice> result,
        Position position,
        int maxCount,
